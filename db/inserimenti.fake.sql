...
insert into gare values('rocks inside champioship', 2018, 2, 'casalecchio', '15/01/2019');
insert into gare values('rocks inside champioship', 2018, 3, 'casalecchio', '15/01/2019');
insert into gare values('rocks inside champioship', 2019, 1, 'casalecchio', '15/01/2019');
